...
const apiList = [
    ...
    // post('userRegister', 'api/user/register', {loading: '加载中', msg: true}),

    post('user_login', 'api/user/login', {loading: '加载中', msg: true}),

    get('user_getListByCon', 'api/user/getListByCon', {loading: '加载中', msg: true}),
]
